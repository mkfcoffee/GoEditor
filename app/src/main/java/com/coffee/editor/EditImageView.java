...
import com.coffee.editor.util.EditorUtils;
...
public class EditImageView extends AppCompatImageView
    ...
    private void resizeImageView(Uri uri) {
        ...
        int viewHeight;
        if (uri != null && EditorUtils.isLocalUri(uri)) {
            final int[] imgWH = EditorUtils.getImageSize(getContext(), uri);
    ...
    public void doUpload() {
        if (uploadEngine != null && mUri != null && EditorUtils.isLocalUri(mUri)
    ...
    public int getUploadStatus() {
        return EditorUtils.isHttp(uploadUrl) ? IUploadEngine.STATUS_UPLOAD_SUCCESS : uploadStatus;
    }
