...
import com.coffee.editor.helper.Effect;
import com.coffee.editor.helper.RichEditText;
import com.coffee.editor.helper.util.SpanTagRoster;
import com.coffee.editor.helper.util.SpannedXhtmlGenerator;
 ...
 */
public class NativeEditor extends ScrollView implements INativeEditor {
    ...
    public NativeEditor(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.NativeEditor);
        editorPaddingLeft = typedArray.getDimensionPixelSize(R.styleable.NativeEditor_ne_paddingLeft, 0);
        editorPaddingRight = typedArray.getDimensionPixelSize(R.styleable.NativeEditor_ne_paddingRight, 0);
        editorPaddingTop = typedArray.getDimensionPixelSize(R.styleable.NativeEditor_ne_paddingTop, 0);
        editorPaddingBottom = typedArray.getDimensionPixelSize(R.styleable.NativeEditor_ne_paddingBottom, 0);
        typedArray.recycle();
    ...
    private RelativeLayout createImageLayout() {
        RelativeLayout layout = (RelativeLayout) inflater.inflate(R.layout.layout_imageview, this, false);
